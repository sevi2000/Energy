            ...
            new MouseAdapter() {
              ...
              public void mousePressed(MouseEvent e) {
                if (selectedLevel != -1) {
                  ...
                  try {
                    plv =
                        new PlayingLevelView(
                            parentWindow,
                            LevelConverter.getLevel(selectedLevel, Level.State.PLAYING, bank),
                            bank);
                ...
                if (selectedLevel != -1) {
                  try {
                    ...
                    Common.showConfirmation(
                        "Empty", "Would you want to empty ?", parentWindow, l, true);
                  } catch (MalformedURLException ex) {
                    throw new RuntimeException(ex);
                  }
                }
